...
def get_basis_bottom(a, d, c, disregistry, zshift='CM'):
...
def get_basis_top(a, d, c, disregistry, zshift='CM'):
...
def create_graphene_geom_bottom(d,disregistry, a=2.462,c=15, zshift='CM'):
    """
    All units should be in angstroms"""
    symbols = ['C', 'C']
    return ase.Atoms(
        symbols=symbols,
        positions=get_basis_bottom(a, d, c, disregistry, zshift=zshift),
        cell=get_lattice_vectors(a, c),
        pbc=[1, 1, 1],
        )

def create_graphene_geom_top(d,disregistry, a=2.462,c=15, zshift='CM'):
    """
    All units should be in angstroms"""
    symbols = ['C', 'C']
    return ase.Atoms(
        symbols=symbols,
        positions=get_basis_top(a, d, c, disregistry, zshift=zshift),
        cell=get_lattice_vectors(a, c),
        pbc=[1, 1, 1],
        )
